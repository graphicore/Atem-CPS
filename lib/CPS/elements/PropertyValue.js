define([
  ...
  , Parent
    ...
    function PropertyValue(value ,source, lineNo) {
        ...
        // FIXME: I think in the future we should also accept
        // other primitives like true, false, null
        // even better may be some sort of duck typing,
        // i.e. if(typeof value.evaluate === 'function') this._setValue(value);
        // ALSO: `undefined` could then throw an error
        if(typeof value === 'string' || typeof value === 'number' )
            // needs a call to initialize then
            this._valueStringArgument = value.toString();
        else
