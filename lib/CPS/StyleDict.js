    ...
    _p._getSubscriptionUid = function(item, key) {
        ...
        if(item instanceof _OMAMode) {
            if(key instanceof SelectorList)
                ...
                // for a _OMAMode have the same SubscriptionUid:
    ...
    _p._subscribeTo = function(item, key) {
        ...
        if(!dependencies) {
            if(key instanceof SelectorList) {
                ...
                // we don't do OMA tree changes anyways.
                assert(item instanceof _OMAMode, 'When "key" is a Selector '
                        +'"item" must be a OMA Element.');
//                subscriberId = item.onSubtreeChange(key, [this, '_invalidateCacheHandler'], subscriptionUid);
//                TODO: make _OMAMode.onSubtreeChange
//                      and any *.cpsGet.onPropertyChange
    ...
    _p._genericGetter = function (item, key) {
        ...
        else if(item instanceof _OMAMode) {
    ...
    _p._loadRules = function(force) {
        ...
        if(this._rules === null || force) {
            ...
            // properties instead of properties. Then a rule and the element
            ...
            this._rules = rules = [[null, {properties: this.element.properties}, null]];
   ...
   /**
     * This method is called when the PropertyCollection of this styleDict
