define([
  ...
  , RootAPI
     ...
     * patterns.
     */
    function OMAController(CPSController, TreeNodesTypes) {
        this.CPSController = CPSController;
        // TODO: inject ruleController!
        // shared across all roots.
        let selectorEngine = new SelectorEngine()
          , ruleController = new RuleController(/*io, cpsDir, initializePropertyValue, ,*/selectorEngine)
          ;
...
//
    ...
    _p._instanciate = function(rootPattern) {
        // build instances
        // from root
        ...
        var rootInstance = Object.create(Instance.prototype)
          ...
          ;
        Instance.call(rootInstance, rootPattern, new RootAPI(controller));
        return rootInstance;
    };
    ...
    _p.bootstrap = function(data/*optional*/) {
        ...
        for ([patternIndex, instancesData] of data.roots) {
            ...
            rootInstance = this._instanciate(rootPattern);
