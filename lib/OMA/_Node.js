define([
  ...
  , bloomfilter
    ...
    _p.cloneProperties = function(clone, cloneFlags) {
        ...
        if(setBaseNode)
            clone.baseNode = this;
        else if(cloneBaseNode && this.baseNode)
            clone.baseNode = this.baseNode;
    };
    ...
    _p.getAttachment = function(key, searchInBaseNodeChain) {
        ...
        if(key in this._attachedData)
            return this._attachedData[key];
        if(searchInBaseNodeChain && this.baseNode)
            return this.baseNode.getAttachment(key, searchInBaseNodeChain);
    };
