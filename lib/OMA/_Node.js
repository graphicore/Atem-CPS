define([
  ...
  , bloomfilter
    ...
    function _Node() {
        ...
        // FIXME: this will be implemented differently, to get rid of
        // the es6 proxy dependency, which situation is not improving at the
        // moment. Losing this dependency will make all of atem much better
        // portable!
    ...
    /**
     * FIXME: I was always not too happy with this in MOM, for no
     *        particular reason. Maybe it can  be changed a bit.
    ...
    // prunded. _getBloomFilterData could stay a part
